    ...
    <>
      <div className="flex justify-start rounded-lg mb-2 border p-4">
        ...
        <div className="overflow-hidden pl-2">
          ...
          <div className="text-sm mt-2">{product?.description.substring(0, 130)}...</div>

          {pathname === "/cart" ? (
            <div className="text-sm mt-2 w-full flex justify-end underline text-blue-500 cursor-pointer">Remove</div>
          ) : null}
        </div>
      </div>
    </>
